    ...
    return (
        <div className="min-h-screen py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-4xl font-bold mb-8 text-white">Restaurants</h1>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {restaurants.map((restaurant) => (
                                <Link
                                    ...
                                    className="card overflow-hidden hover:scale-105 transition-transform group"
                                >
                                    ...
                                    <div className="p-4">
                                        <h3 className="text-xl font-semibold mb-2 text-gray-100 group-hover:text-primary-400 transition-colors">{restaurant.name}</h3>
                                        ...
                                        <div className="flex items-center justify-between text-sm text-gray-400">
                                            <div className="flex items-center space-x-1">
                                                ...
                                                <span className="text-gray-300">{restaurant.rating.toFixed(1)}</span>
                                            </div>
                                            <div className="flex items-center space-x-1">
                                                <MapPin size={16} />
