        ...
        <div className="min-h-screen bg-gray-950 py-8">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg shadow-md p-6 mb-6">
                    {cart.map((item) => (
                        <div key={item.id} className="flex items-center justify-between border-b border-gray-800 py-4 last:border-b-0">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <p className="font-bold text-primary-500 w-20 text-right">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg shadow-md p-6">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="btn-primary w-full disabled:opacity-50 shadow-lg shadow-primary-900/20"
                    >
                        Proceed to Payment
                    </button>
                </div>
            ...
            {showPaymentModal && (
                <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
                    <div className="bg-gray-900 border border-gray-800 rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl">
                        ...
                        <div className="p-6">
                            <div className="mb-6">
                                <p className="text-gray-400 mb-2">Order Total</p>
                                <p className="text-3xl font-bold text-primary-500">₹{total}</p>
                            </div>

                            <div className="space-y-4 mb-6">
                                <p className="font-semibold text-gray-200">Select Payment Method</p>

                                <div
                                    onClick={() => setPaymentMethod('upi')}
                                    className={`border-2 rounded-lg p-4 cursor-pointer transition-all ${paymentMethod === 'upi' ? 'border-primary-500 bg-gray-800' : 'border-gray-700 hover:border-gray-600 bg-gray-800/50'
                                        }`}
                                >
                                    <div className="flex items-center space-x-3">
                                        <Smartphone className="text-primary-500" size={24} />
                                        <div>
                                            <p className="font-semibold text-gray-200">UPI</p>
                                ...
                                <div
                                    ...
                                    className={`border-2 rounded-lg p-4 cursor-pointer transition-all ${paymentMethod === 'card' ? 'border-primary-500 bg-gray-800' : 'border-gray-700 hover:border-gray-600 bg-gray-800/50'
                                        }`}
                                >
                                    <div className="flex items-center space-x-3">
                                        <CreditCard className="text-primary-500" size={24} />
                                        <div>
                                            <p className="font-semibold text-gray-200">Credit/Debit Card</p>
                                            <p className="text-sm text-gray-400">Pay using card</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    className={`border-2 rounded-lg p-4 cursor-pointer transition-all ${paymentMethod === 'cod' ? 'border-primary-500 bg-gray-800' : 'border-gray-700 hover:border-gray-600 bg-gray-800/50'
                                        }`}
                                >
                                    <div className="flex items-center space-x-3">
                                        <Wallet className="text-primary-500" size={24} />
                                        <div>
                                            <p className="font-semibold text-gray-200">Cash on Delivery</p>
