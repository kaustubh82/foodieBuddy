...
This is the backend for the foodieBuddy food delivery platform, built with Node.js, Express, and Prisma (MongoDB).
...
2.  **Environment Variables**
    ...
    ```env
    DATABASE_URL="mongodb+srv://<username>:<password>@<cluster>.mongodb.net/foodiebuddy?retryWrites=true&w=majority"
